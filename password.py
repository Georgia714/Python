def password_checker():
    ...
    while (u < 1 and l < 1 and sc < 1 and n < 1 and (u+l+sc+n != len(password))):
        for i in range(len(password)):
            ...
            #((password[i] == '@') or (password[i] == "!") or (password[i] == "$") or (password[i] == "£") or (password[i] == "#") or (password[i] == "%") or (password[i] == "&") or (password[i] == "*") or (password[i] == "?") or (password[i] == "/") or (password[i] == "~")):
                sc += 1
